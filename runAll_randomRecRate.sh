...
BASEDIR=$PWD
slimTemplate=$BASEDIR/code/randomRecRate.slim
workDir=$BASEDIR/randomRecRate
numReps=1000
...
for num in $N
  do
  let counter="250000 / $num - 1" #re-ran code with this and increased memory for N=2.5M
