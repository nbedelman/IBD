...
workDir=$BASEDIR/hillRobertson
numReps=2000
outBase=hillRobertson
numGens=200
...
N=2500000
#N=$(echo 250 2500 25000 250000 2500000)
...
for num in $N
  ...
  let counter="5000000 / $num - 1" #re-ran code with this and increased memory for N=2.5M
